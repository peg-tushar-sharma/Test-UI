...
import { UserProfileTooltipComponent } from './user-profile-tooltip/user-profile-tooltip.component';
...
describe('DealAllocationComponent', () => {
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            declarations: [DealAllocationComponent, EditAllocationNotesComponent, UserProfileTooltipComponent],
